...
def get_config():
    ...
    sample.batch_size = 1
    # whether to shuffle the prompt dataset. set to False for deterministic alternation.
    sample.shuffle_dataset = True
