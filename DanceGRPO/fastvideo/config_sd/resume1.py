...
def resume1():
    ...
    config.run_name = "grpo_giraffe_flamingos_resume"
    ...
    # Resume from Exp1 ep400 checkpoint
    config.lora_checkpoint = "/workspace/oyly/checkpoints/grpo_giraffe_flamingos_2026.05.27_09.17.45_ep400"
